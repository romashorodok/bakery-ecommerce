...
// var hammingDistance = function (hash1: any, hash2: any) {
//   var d = 0;
//   var i;
//
...
var median = function (data: Array<number>) {
...
var translate_blocks_to_bits = function (blocks: Array<number>, pixels_per_block: number) {
...
var bits_to_hexhash = function (bitsArray: Array<number>) {
  var hex = [];
...
var bmvbhash_even = function (data: ImageData, bits: number) {
...
var bmvbhash = function (data: ImageData, bits: number) {
  // @ts-ignore
  var result = [];
...
var blockhashData = function (imgData: ImageData, bits: number, method: 1 | 2) {
  var hash;
